...
| `color`   | `#!python str` \| `#!python tuple`    | The color of the icon. May be an [`rx.color` object](https://reflex.dev/docs/styling/theming/#shades), a [Pydantic-recognized color definition](https://docs.pydantic.dev/2.0/usage/types/extra_types/color_types/), or `#!python "brand"` to use the icon's brand color. |                                                                                                                                                                                                                                                                                            |
